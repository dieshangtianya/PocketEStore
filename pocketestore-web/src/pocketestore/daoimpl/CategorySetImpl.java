...
public class CategorySetImpl implements ICategorySetDao {
    ...
    @Override
    public List<CategorySet> getAll() {
        String commandSql = "SELECT t_CategorySet.Id as CategorySetId,SetName,OrderNum,t_Category_Set_Link.CategoryId,CategoryName\n" +
                " FROM t_CategorySet " +
                " LEFT JOIN t_Category_Set_Link ON t_CategorySet.Id=t_Category_Set_Link.SetId " +
                " LEFT JOIN t_Category ON t_Category.Id=t_Category_Set_Link.CategoryId " +
                " WHERE SetType='1' and CategoryName IS NOT NULL AND t_Category.ParentId IS NULL " +
                " AND t_Category.State='1'";
    ...
    @Override
    public List<CategorySet> get(int pageIndex, int pageSize) {
        return null;
    }
    ...
    @Override
    public boolean add(CategorySet entity) {
        return false;
    }

    @Override
    public boolean update(CategorySet entity) {
        return false;
    }
